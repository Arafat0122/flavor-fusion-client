        ...
        <div>
            ...
            <div className="space-y-5 max-w-lg lg:max-w-5xl mx-auto mb-5">
                <div className="text-center">
                    <input className="border-4 border-[#47691b] border-r-0 w-1/3 lg:w-10/12 py-2 px-2 rounded-l-full" type="text" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} />
                    <button className="border-4 border-[#47691b] border-l-0 py-2 pl-3 pr-3 lg:pr-7 rounded-r-full bg-[#47691b] text-white font-bold" onClick={handleSearch}>Search</button>
                </div>
