...
const SingleFood = () => {
    ...
    const { foodName, foodImage, foodCategory, price, quantity } = foods;
        ...
        <div>
            ...
            <div className="flex flex-col items-center relative">
                ...
                <div className="absolute top-28">
                    ...
                    <div className='w-32 h-32 text-2xl text-white flex gap-2 items-center justify-center rounded-full shadow-2xl bg-black ring-8 ring-white absolute top-20 left-80 hover:scale-125'>
